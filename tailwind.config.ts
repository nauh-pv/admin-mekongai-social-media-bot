  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        blueColor: "#209CFF",
        greenColor: "#68E0CF",
        blueColorShadow: "#008eff",
        greenColorShadow: "#00debf",
        bgDark: "#020617",
        bgDarkReduce: "#0f172a",
        textColorDark: "#bae6fd",

        colorBgDark: "#0f172a",
        colorBgDarkReduce: "#020617",
        colorBgDarkReduceP: "#1e293b",
        colorBgLight: "#f1f5f9",
        colorBgLightReduce: "#ffffff",
        colorBgLightReduceP: "#e2e8f0",

        cyanBlueDark: "#22d3ee",
        cyanBlueLight: "#0284c7",
        colorTextDark: "#d1d5db",
        colorTextDarkReduce: "#9ca3af",
        colorTextLight: "#0f172a",
        colorTextLightReduce: "#334155",

        colorBorderDark: "#1e293b",
        colorBorderLight: "#e2e8f0",

        graFrom: "#0284c7",
        graTo: "#34d399",

        graFromHotColor: "#e43a15",
        graToHotColor: "#ffe682",

        colorIcon: "#e5e7eb",
        colorHoverInput: "#67e8f9",

        disabledText: "#64748b",
        autofill: "#f0f8ff",

        scrollbarDark: "#1f2937",
        scrollbarThumbDark: "#4b5563",
      },
      backgroundSize: {
        "size-200": "200% 200%",
      },
      backgroundPosition: {
        ...
        "border-gradient-dark":
          "linear-gradient(to right, #1e293b, #1e293b), linear-gradient(to right, #34d399, #0284c7)", // Slate 900
      },
      gradientColorStops: {
        primary: "rgb(var(--primary))",
        secondary: "rgb(var(--secondary))",
      ...
      animation: {
        "pulse-slow": "pulse 2s ease-in-out infinite", // Phóng to thu nhỏ chậm
      },
      keyframes: {
        pulse: {
