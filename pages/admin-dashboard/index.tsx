...
const DashBoardUser = () => {
  ...
  const { handleConnectFacebook } = useAppContext();
                  ...
                  <div className="box-body">
                    <div className="flex items-center justify-between">
                      <div className="flex flex-col gap-2">
                        <div className="font-semibold text-[1.125rem] text-white">
                          Connect your social account
                        </div>
                        <span className="block text-[0.75rem] text-white">
                          <span className="opacity-[0.7] me-1">
                            Let us manage your social networks for you
                          </span>
                        </span>
                        <TreeSelectPage />
                        <span className="block font-semibold mt-[0.125rem]">
                          <button
                            className="text-[0.813rem] border border-sky-500 text-sky-300 rounded-full p-2"
